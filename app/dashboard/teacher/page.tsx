...
export default async function TeacherDashboard() {
  ...
  // --- This week's schedule (today highlighted separately in the client) ---
  ...
  // --- Today's attendance, per class, with per-student roster ---
  ...
  // --- Student performance: most recent grade per subject (gradeValue is a string like "A", "B+") ---
